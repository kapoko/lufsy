...
APPCAST_URL_ARM64 ?= https://lufsy.koman.app/appcast-arm64.xml
APPCAST_URL_X86_64 ?= https://lufsy.koman.app/appcast-x86_64.xml
...
# Create DMGs for both architectures using create-dmg
dmg: dmg-x86_64 dmg-arm64
	@echo "Both architecture DMGs created"
